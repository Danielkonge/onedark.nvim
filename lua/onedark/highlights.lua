...
hl.treesitter = {
    ...
    ["@variable.parameter.builtin"] = colors.Orange,
    ...
    ["@string"] = { fg = c.green, fmt = cfg.code_style.strings },
    ["@string.documentation"] = { fg = c.dark_yellow, fmt = cfg.code_style.documentation },
    ...
    ["@string.special.path"] = colors.Blue,
    ["@string.special.url"] = { fg = c.cyan, fmt = 'underline' },

    ["@character"] = colors.Orange,
    ["@character.special"] = { fg = c.dark_yellow },
    ...
    ["@markup.raw.block"] = colors.Fg,

    ["@markup.list"] = colors.Orange,
...
hl.plugins.lsp = {
    ...
    LspInlayHint = { fg = c.light_grey, bg = c.none },
...
function M.setup()
    ...
    -- user defined highlights: vim_highlights function cannot be used because
    -- it sets an attribute to none if not specified
